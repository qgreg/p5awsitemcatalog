...
class CategoryForm(Form):
    name     = StringField('Name', [validators.Length(min=4, max=250, message="name problem")])
    description = StringField('Description', [validators.Length(max=250, message="description problem")])
    picture = StringField('Picture URL', [
    	validators.Optional(), validators.Length(max=250, message="picture length problem"), 
